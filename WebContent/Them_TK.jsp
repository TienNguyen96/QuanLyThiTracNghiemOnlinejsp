...
<!--header_top-->
	...
	<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title" style="">Thêm tài khoản</h3>
					</div>
					<div class="panel-body">
						<form id="ThemtkForm" method="post" class="form-horizontal" action="">
							...
							<div class="form-group">
							    <div class="col-sm-9 col-sm-offset-4">
									<button type="sumit" class="btn btn-primary" name="OK" value="">Ok</button>
									<button type="button" class="btn btn-primary" name="Cancel" value=""><a href="Admin_Thongtincanhan.jsp" style="color: white">Cancel</a></button>
								</div>
							</div>
						</form>
					</div>
...
<script type="text/javascript">
		$.validator.setDefaults( {
			submitHandler: function () {
				...
				location = "Admin_Thongtincanhan.jsp";
			}
		} );
